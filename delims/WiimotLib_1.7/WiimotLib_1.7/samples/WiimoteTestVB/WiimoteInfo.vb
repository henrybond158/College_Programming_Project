...
Namespace WiimoteTest
    Partial Public Class WiimoteInfo
        ...
        Private Sub pbBattery_Click(ByVal sender As Object, ByVal e As EventArgs) Handles pbBattery.Click

        End Sub

        Private Sub lblDevicePath_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lblDevicePath.Click
